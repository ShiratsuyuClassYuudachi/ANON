...
- 右上角头像菜单 →「帮助文档」进入 `/help`：内置图文使用手册，共 **7 章**（快速上手 / 待办 / 财务 / 物料 / 账号 / 现场 / 权限与角色），每章配真实界面截图
...
- **页面结构**：
  - `/projects` 项目列表与新建
  - `/p/:id` 项目工作台：待办 / 财务 / 物料 / 账号 / 现场 / 成员 / 角色 / 设置 八个 Tab（**按项目内权限点过滤可见性**：「角色」需 role:manage 及以上、「设置」需 project:manage、「财务」需 finance:add/manage 其一，无权限的 Tab 与操作按钮不渲染）
